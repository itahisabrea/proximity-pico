...
extern void ssd1306_draw_char_absolute(uint8_t *ssd, int16_t x, int16_t y, uint8_t character);
extern void ssd1306_draw_string_absolute(uint8_t *ssd, int16_t x, int16_t y, const char *string);
extern void ssd1306_draw_string_with_word_wrap(uint8_t *ssd, int16_t x, int16_t y, const char *string);
